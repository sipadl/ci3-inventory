	...
	<tbody>
		<?php foreach($file as $key => $files): ?>
			<tr>
				...
				<a class="btn btn-primary btn-sm" href="<?php echo base_url('main/approval_upload_bb/'.$files['id']); ?>">Approve</a>
				...
				<div class="modal fade" id="modelId-<?= $files['id']?>" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							...
							<form action="<?php echo base_url('main/reject_bb/'.$files['id']); ?>" method="post" enctype="multipart/form-data">
