            ...
            <div class="modal-dialog modal-lg modal-fullscreen">
                <div class="modal-content">
                    ...
                    <div class="modal-body container">
                        <form
                            method="post"
                            action="<?php echo base_url('main/tambahSuplier'); ?>"
        ...
        <table class="table" id="myTable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo $supplier['no_rekening']; ?></td>
                    ...
                    <td>
                        ...
                        <img
                            width="50"
                            height="50"
                            src="<?php echo base_url('upload/images/' . $supplier['npwp']); ?>"
                            alt="NPWP Image">
                    <?php else: ?>
                        No NPWP Image
                        <?php endif; ?>
                    ...
                    <td>
                        ...
                        <img
                            width="50"
                            height="50"
                            src="<?php echo base_url('upload/images/' . $supplier['no_ktp']); ?>"
                            alt="KTP Image">
                    <?php else: ?>
                        No KTP Image
                        <?php endif; ?>
                        ...
                        <div class="d-flex">
                            <div class="">
                                <button
                                    ...
                                    data-toggle="modal"
                                    data-target="#myModalSuplier-<?php echo $supplier['kode_supplier'] ?>">
                                    Ubah
                                </button>
                                <div
                                    class="modal fade"
                                    id="myModalSuplier-<?php echo $supplier['kode_supplier'] ?>">
                                    <div class="modal-dialog modal-lg modal-fullscreen">
                                        <div class="modal-content">
                                            <!-- Modal Header -->
                                            <div class="modal-header">
                                            ...
                                            <div class="modal-body container">
                                                <form
                                                    method="post"
                                                    action="<?php echo base_url('main/updateSupplier/'.$supplier['kode_supplier']); ?>"
                                                    enctype="multipart/form-data">
                                                    <div class="form-row">
                                                        <div class="form-group col-md-6">
                                                            <label for="id_supplier">Kode Supplier</label>
											...
											id="
                                                        ...
                                                        <!-- <div class="form-group col-md-6"> <label for="area">Kode Area</label><br>
                                                        <select name="id_area" class="form-control col-md-12" id="basic-multiple" >
                                                        <option value="">Pilih Area</option> <?php foreach($wilayah as $wil) : ?>
                                                        <option value="<?php echo $wil['kode_area'] ?>"><?php echo $wil['kode_area'].' -
                                                        '. $wil['nama_area'] ?></option> <?php endforeach ?> </select> </div> -->
                                                    </div>
                                                    <div class="form-group col-md-12">
                                                        <label for="no_ktp">Nomor Rekening</label>
                                                        <input
                                ...
                                <a
                                    href="<?php echo base_url('main/deleteSupplier/'.$supplier['id_supplier']); ?>"
                                    class="btn btn-sm btn-danger mx-1">Hapus
                                </a>
                            </a>
                        </div>
                    </td>
