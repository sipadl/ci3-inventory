  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="<?php echo base_url('main/upload_bahan_baku_dua'); ?>" method="post" enctype="multipart/form-data">
					...
					<div class="modal fade" id="modelIdUbah-<?php echo $files['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="modelTitleIdUbah" aria-hidden="true">
						<div class="modal-dialog" role="document">
							<div class="modal-content">
								...
								<div class="modal-body">
								<form action="<?php echo base_url('main/upload_bb_dua/'.$files['id']); ?>" method="post" enctype="multipart/form-data">
									<div class="form-group">
										<label for="file">Pilih File</label>
										<input type="file" class="form-control" id="file" name="file" required>
									</div>
